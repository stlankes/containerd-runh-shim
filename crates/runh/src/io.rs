...
///
/// With this Io driver, methods of [crate::Runh] may capture the output/error messages.
...
///
/// With this Io driver, all methods of [crate::Runh] can't capture the output/error messages.
#[derive(Debug)]
pub struct NullIo {
